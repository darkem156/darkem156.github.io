        ...
        <div id="presentation-container" className="section">
          <div id="presentation">
            <div id="titles">
             ...
             <h3 id="subtitle">JR Web Developer</h3>
            </div>
           <img id="me" width="100%" src="./assets/yo.png" />
          </div>
          <p id="description">
            I am a Mexican Student and Web Developer. I am 17-years-old and I have experiencie with Personal Projects in the Node JS Environment
          </p>
